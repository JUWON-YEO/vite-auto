...
import { setDocumentTitle, getNode, setStorage, getStorage } from "kind-tiger";
...
tl.from(".container h1", { delay: 0.2, y: 30 }).from(".container hr", { scaleX: 0 }).from("form > *", { y: 30, stagger: 0.1 }).from(".register", { y: -30 }, "-=0.2");
